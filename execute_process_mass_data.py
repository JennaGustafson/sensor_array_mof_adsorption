...
normalize_binned_pmf_results = normalize_binned_pmf(gases, number_mofs, mof_array, bin_compositions_results, create_bins_results)
# plot_binned_pmf_array(gases, mof_array, bin_compositions_results, create_bins_results)
kl_divergence = information_gain(normalize_binned_pmf_results, create_bins_results)
print(kl_divergence)
